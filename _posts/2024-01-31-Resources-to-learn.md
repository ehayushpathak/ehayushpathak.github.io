---
title: "Resources to learn AWS Security"
date: 2024-01-31
categories: [AWS, Cloud, Security]
tags: [AWS, Security, Resources]
---
...
- [AWS Cloud Simulation](https://github.com/XMCyber/AWSCloudSimulation)
...
- [aws-inventory](https://github.com/janiko71/aws-inventory)
- [GrayHat Warfare](https://grayhatwarfare.com/)
- [cloud-enum](https://github.com/initstring/cloud_enum)
- [List of AWS Exposable Resources](https://github.com/SummitRoute/aws_exposable_resources)
- [Cartography](https://github.com/lyft/cartography)
- [Cloudsplaining](https://github.com/salesforce/cloudsplaining) - Publicly archieved now
...
- [AWS Pentesting Guide - HTB](https://www.hackthebox.com/blog/aws-pentesting-guide)
- [Security Learning - AWS](https://aws.amazon.com/security/security-learning/)
- [HackTricks - AWS](https://cloud.hacktricks.xyz/pentesting-cloud/aws-security)
- [AWS CLI Tool Cheatsheet](https://github.com/dafthack/CloudPentestCheatsheets/blob/master/cheatsheets/AWS.md)
- [Cloud penetration testing - Seth Art](https://sethsec.blogspot.com/2022/12/cloud-penetration-testing-not-your.html)
- [AWS Penetration Testing - Nick Jones](https://www.nojones.net/posts/on-aws-pentesting)
...
- [https://onecloudplease.com/](https://onecloudplease.com/)
- [https://awsteele.com/](https://awsteele.com/)
- [https://christophetd.fr/](https://christophetd.fr/)
- [Customer security incidents](https://github.com/ramimac/aws-customer-security-incidents)
- [https://chrisfariss.com](https://chrisfariss.com)
- [https://breaches.cloud](https://breaches.cloud)
- [CloudSecWiki](https://cloudsecwiki.com/aws_cloud.html)
...
- [CloudSec Academy- Wiz](https://www.wiz.io/academy)
...
- [Pwned Labs](https://pwnedlabs.io/login)
- [CloudFoxable](https://cloudfoxable.bishopfox.com/)
- [Refining IAM Permissions](https://catalog.workshops.aws/refining-iam-permissions-like-a-pro/en-US)
...
- [Cloudsec tidbits](https://github.com/doyensec/cloudsec-tidbits/)
- [AWS Control Tower Guide](https://catalog.workshops.aws/control-tower/en-US)
- [Well Architected Labs](https://www.wellarchitectedlabs.com/)
- [http://flaws.cloud](flaws.cloud)
- [http://flaws2.cloud](flaws2.cloud)
...
- [AWS Power House - Specialty](https://pages.awscloud.com/GLOBAL_TRAINCERT_T2-Twitch-AWS-Power-Hour-Specialty-Certification.html#undefined)
- [Security Exploration - AWS Verified Permissions](https://youtu.be/VsZN7lcWFy8?si=UsZFJohXB96XG9uu)
- [Penetrating the Cloud: Uncovering Unknown Vulns](https://youtu.be/ScBgca_zCCo?si=xqvLRThFSe87LizY)
